...
import { bookcontent, bookmulu, bookhy } from '../../api/index.js';
  ...
  methods: {
    ...
    getmulu(id) {
      ...
      bookmulu(id).then((res) => {
        ...
        console.log('bookindexs 100',bookindexs);
        console.log('bookindexs[this.getBook._id]200',bookindexs[this.getBook._id]);
        this.iss =
          bookindexs && bookindexs[this.getBook._id]
            ? bookindexs[this.getBook._id].bookindex
            : this.iss;
        console.log('yy',this.iss);
        this.getcontent(this.booklinkss[this.iss]);
